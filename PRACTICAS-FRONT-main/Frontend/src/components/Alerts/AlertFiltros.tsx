...
interface AlertFiltrosProps {
  onClose: () => void;
}

const AlertFiltros: React.FC<AlertFiltrosProps> = ({ onClose }) => {
    ...
    >
      ...
      >
        ...
        <p className="text-sm text-gray-700 text-center font-semibold">
          ...
          seleccionados.
          <br />
          Revisa las fechas o el tipo de solicitud e intenta nuevamente.
        </p>
